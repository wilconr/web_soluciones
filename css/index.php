            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-offset-2 col-md-8 col-sm-12">
                        ...
                        <h4 class="font-weight-normal font-color-gray wow fadeInUp" data-wow-delay="1s">ofrecemos servicos tecnologicos con experiencia y profesionalismo en seguridad electronica como son: instalacion de circuitos cerrados de televison, cercas electricas, desarrollo de sitios web, alarmas de seguridad, mantenimiento
                            y reparacion de equipos de computo, controles de acceso, camaras de vigilancia y redes de datos.</h4>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="1.3s">
                        ...
                        <p>Somos una empresa Santandereana dinámica, flexible, que nos adaptamos al cambio, nuestra experiencia en el área de la tecnología y seguridad privada nos brindó los ingredientes adecuados para prestar servicios ajustados a las necesidades
                            de los clientes. La innovación es una de nuestras preocupaciones, con un equipo humano comprometido y altamente profesional, aportando al crecimiento económico, equilibrio ecológico, progreso social y Experiencia en el campo
                            profesional, brindando oportunidades de desarrollo profesional.</p>
                    </div>

                    <div class="col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="1.3s">
                        <h1>Politicas de Calidad</h1>
                        <p>Lograr la satisfacción total de nuestros clientes, mediante soluciones tecnológicas efectivas, realizando seguimiento y verificación al servicio prestado y proyectos finalizados. En el cumplimiento de nuestra Misión, observaremos
                            las siguientes aptitudes para garantizar la satisfacción de nuestros clientes: Amabilidad en el servicio y Agilidad en los Procesos, Honestidad, Responsabilidad, Compromiso con cada proyecto emprendido, Innovación práctica
                            y efectiva en los servicios y eficiencia en costos, Cumplimiento y mejora de las normas de calidad, Desarrollo Integral del personal de servicio técnico.</p>
                    </div>

                    <div class="col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="1.6s">
                        <div class="embed-responsive embed-responsive-16by9">
                            <h1>Mision</h1>
                            <p>Ofrecer soluciones Integrales de Tecnología, en los ámbitos de Sistemas, seguridad electrónica, redes de telecomunicaciones, automatismos y web hosting para satisfacer las necesidades empresariales y particulares de nuestros
                                clientes; con servicios innovadores, eficientes, efectivos y de alta calidad, garantizando la satisfacción total en cada proyecto realizado.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-10 wow fadeInUp" data-wow-delay="1.6s">
                        <div class="embed-responsive embed-responsive-16by9">
                            <h1>Vision</h1>
                            <p>Soluciones é Ingeniería en 2021 se consolidara como una de las empresas de servicios Tecnológicos más importantes del Territorio nacional cumpliendo con los estándares de Calidad, seguridad y cumplimiento; reconocida como modelo
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        <p>Lorem ipsum dolor sit amet, maecenas eget vestibulum justo imperdiet, wisi risus purus augue vulputate voluptate neque, curabitur dolor libero sodales vitae elit massa. Lorem ipsum dolor sit amet, maecenas eget
                                            vestibulum justo imperdiet.</p>
                    ...
                    <div id="owl-testimonial" class="owl-carousel">
                        ...
                        <div class="item col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="0.9s">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <p>Lorem ipsum dolor sit amet, maecenas eget vestibulum justo imperdiet, wisi risus purus augue vulputate voluptate neque, curabitur dolor libero sodales vitae elit massa. Lorem ipsum dolor sit amet, maecenas eget vestibulum
                                        justo imperdiet</p>
...
================================================== -->
        ...
        ================================================== -->
                    <div class="col-md-offset-2 col-md-8 col-sm-12">
                        <div class="section-title">
                            <h1>Ubicanos</h1>
                            <p>Nuetsras oficinas en piedecusta.</p>
                        </div>
                    </div>
                    <!-- Map form section
            ================================================== -->
                    <iframe class="mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.1159786333474!2d-73.05650868597873!3d6.995619994946513!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e6847083884a62f%3A0xa12ccda841caab61!2sSoluciones+%C3%A9+Ingenier%C3%ADa!5e0!3m2!1sen!2sco!4v1504758262565"
        ...
        <section id="contact" class="parallax-section">
			...
			================================================== -->
                    <div class="col-md-offset-2 col-md-8 col-sm-offset-1 col-sm-10 wow fadeIn " data-wow-delay="0.6s">
                        <form class="formulario" method="post" id="formulario_contacto" onsubmit="validaForm(); return false;">
